...
st.image(Image.open("C:\\Users\casba\PycharmProjects\FINANCE_NOTEBOOK\img\singleStockAndOptions_call.JPG"), 'call payoff')

st.subheader('PUT')
st.latex("put  =  n * max[0,K  -  s]")
st.image(Image.open("C:\\Users\casba\PycharmProjects\FINANCE_NOTEBOOK\img\singleStockAndOptions_put.JPG"), 'put payoff')
